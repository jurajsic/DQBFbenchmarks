...
# DQBDD tool definition by Juraj Síč
...
class Tool(benchexec.tools.template.BaseTool):
    ...
    def executable(self):
        return util.find_executable('DQBDDoneexistelim')

    def name(self):
        return 'DQBDDoneexistelim'

    def version(self, executable):
        return self._version_from_tool(executable).split(' ',1)[1]
